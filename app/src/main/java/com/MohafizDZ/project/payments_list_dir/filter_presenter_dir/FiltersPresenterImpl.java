...
public class FiltersPresenterImpl implements IFiltersPresenter.Presenter{
    ...
    private boolean isBackOrders, isSales, isFreePaymentsOnly;
    ...
    public void onViewCreated() {
        filters = new Filters(isSales, isBackOrders, isFreePaymentsOnly);
        initData();
    ...
    private void prepareAutoCompleteFilters() {
        ...
        filters.customerName = selectedCustomerId != null? customersMap.get(selectedTourId) : null;
    ...
    private void prepareDefaultFilters(){
        ...
        view.setFreePaymentsOnlyChecked(filters.isFreePayments);
    ...
    public void onResetClicked() {
        filters = new Filters(isSales, isBackOrders, isFreePaymentsOnly);
        filters.isPayments = isSales;
        filters.isRefund = isBackOrders;
        prepareDefaultFilters();
        onRefresh();
    }
    ...
    @Override
    public void setPayments(boolean isSales) {
        this.isSales = isSales;
    }

    @Override
    public void setRefunds(boolean isBackOrders) {
        this.isBackOrders = isBackOrders;
    }

    @Override
    public void checkFreePayments(boolean isFreePaymentsOnly) {
        this.isFreePaymentsOnly = isFreePaymentsOnly;
    }
    ...
    @Override
    public void setOrdersOnly(boolean checked) {
        filters.isOrder = checked;
        onRefresh();
    }

    @Override
    public void setFreePaymentsOnly(boolean checked) {
        filters.isFreePayments = checked;
        onRefresh();
    }
