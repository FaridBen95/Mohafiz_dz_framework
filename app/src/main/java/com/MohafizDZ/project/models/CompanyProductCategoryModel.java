...
public class CompanyProductCategoryModel extends Model {
    private static final String TAG = CompanyProductCategoryModel.class.getSimpleName();
    ...
    public CompanyProductCategoryModel(Context mContext) {
        super(mContext, "company_product_category");
    }
    @Override
